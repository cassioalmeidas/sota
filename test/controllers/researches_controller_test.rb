...
class ResearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post researches_url, params: { research: { description: @research.description, user_id: @research.user_id } }
    end
  ...
  test "should update research" do
    patch research_url(@research), params: { research: { description: @research.description, user_id: @research.user_id } }
